<form method="POST" action="{{ route('deployments.store') }}" x-data="{ showPassword: false, submitting: false }" @submit="submitting = true">
    ...
    <div class="grid gap-5 lg:grid-cols-2">
        ...
        <div>
            <label for="ssh_command" class="text-sm font-medium text-slate-700">Commande SSH</label>
            ...
            <p class="mt-1.5 text-xs text-slate-500">Collez la commande fournie par Hostinger.</p>
        ...
        <div>
            ...
            <div class="relative mt-1">
                <input id="ssh_password" name="ssh_password" :type="showPassword ? 'text' : 'password'" autocomplete="new-password" class="block w-full rounded-md border-slate-300 pr-20 text-sm focus:border-emerald-500 focus:ring-emerald-500" placeholder="Première connexion uniquement">
            ...
            <p class="mt-1.5 text-xs text-slate-500">Jamais enregistré par la plateforme.</p>
